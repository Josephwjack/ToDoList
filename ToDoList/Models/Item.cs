...
namespace ToDoList.Models
{
  public class Item
  {
    ...
    // }  
    // equals is built in -- to override we use the override keyword
    // equals accepts any type of object, we use the generic system.object type as  its arguement
    // conditional makes sure otheritem is in fact an item
    //typecasting to ensure otheritem is in fact item, method will break without this
